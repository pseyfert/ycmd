...
def GetCmakeArgs( parsed_args ):
  ...
  cmake_args.append('-DEXTERNAL_LIBCLANG_PATH=/cvmfs/sft.cern.ch/lcg/contrib/llvm/7.0.0binutils/x86_64-centos7-gcc8-opt/lib/libclang.so')
  cmake_args.append('-DPATH_TO_LLVM_ROOT=/cvmfs/sft.cern.ch/lcg/contrib/llvm/7.0.0binutils/x86_64-centos7-gcc8-opt/')
